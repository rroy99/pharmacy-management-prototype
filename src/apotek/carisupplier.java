 ...
 * @author user
 */
public class carisupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Note : masukkan id/nama supplier");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        try {
            koneksi();
            String sql = "Select * from supplier where idsupplier like'%" + jTextField1.getText() + "%'or namasupplier like'%" + jTextField1.getText() + "%' ";
            ResultSet rs = cn.executeQuery(sql);
            while (rs.next()) {
                tabelnyo.addRow(new Object[]{
                    rs.getString(1),
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        po.jTextField1.setText(tabel.getValueAt(row, 0).toString());
        po.jTextField2.setText(tabel.getValueAt(row, 1).toString());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new carisupplier().setVisible(true);
            }
        });
    }
