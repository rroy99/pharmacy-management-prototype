...
public class daftar extends javax.swing.JFrame {
    ...
    public void daftar() {
        try {
            koneksi();
            String sql = "Select * from user where id='" + jTextField1.getText() + "'";
            ResultSet rs = cn.executeQuery(sql);
            if (rs.next()) {
                ...
                try {
                    int kel = JOptionPane.showConfirmDialog(this, "id :" + jTextField1.getText() + "Sudah ada, Mau Di Edit atau di haspus...?", "INFORMASI", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\OneDrive - Yayasan Vitka\\Documents\\NetBeansProjects\\apotek\\download.png")); // NOI18N
        ...
        jLabel3.setText("* Pendaftaran akun baru");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            tampil();
            bersih();
            JOptionPane.showMessageDialog(null, "Data berhasil di simpan silahkan kembali ke menu login");
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            koneksi();
            String sql = "update user set id='" + jTextField1.getText() + "',"
                    + "username='" + jTextField2.getText() + "'"
                    + "where password='" + jTextField3.getText() + "'";
            cn.executeUpdate(sql);
            cn.close();
            tampil();
            bersih();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if (keluar == JOptionPane.YES_OPTION) {
                try {
                    koneksi();
                    String sql = "delete from user where id='" + jTextField1.getText() + "'";
                    cn.executeUpdate(sql);
                    cn.close();
                    tampil();
                    bersih();
